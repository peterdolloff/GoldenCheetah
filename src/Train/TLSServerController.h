...
#ifndef _GC_TLSServerController_h
#define _GC_TLSServerController_h 1
...
class TLSServerController : public RealtimeController
{
    Q_OBJECT;
    ...
    public:
        ...
        TLSServerController(TrainSidebar *parent, DeviceConfiguration *dc);
        ~TLSServerController();
...
#endif // _GC_TLSServerController_h
